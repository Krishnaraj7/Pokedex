  ...
  return (
    <>
      <div className="fixed top-0 left-0 w-full bg-white z-10 shadow-xl pb-6">
        <img src={logo} className="w-36 md:w-48 lg:w-[270px] absolute py-5 px-4" alt="Logo" />
        <Link to="/bookmarks">
        <BsFillBookmarkFill size={25} className="absolute right-0 mt-[30px] md:mt-[50px] mr-7" />
        </Link>
